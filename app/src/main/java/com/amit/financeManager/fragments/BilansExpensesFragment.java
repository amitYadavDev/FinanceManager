...
public class BilansExpensesFragment extends Fragment implements ClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bilans_expenses, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
        transMoney = getView().findViewById(R.id.bilans_expenses_transaction_money);
        transCount = getView().findViewById(R.id.bilans_expenses_transaction_count);
        getData(view);
    }

    private void getData(View view) {
        DatabaseHelper databaseHelper = new DatabaseHelper(context);
        eventList = databaseHelper.getAllEventsExpensesByMonth(SpinnerNameTransporter.getName());

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.bilans_expenses_events_list);
    ...
    private void getFullMoneyReport(){
        DatabaseHelper databaseHelper = new DatabaseHelper(context);
        transaction_money= databaseHelper.getMoneyExpenseByMonth(SpinnerNameTransporter.getName());
        setColor(transaction_money, transMoney);
    }
