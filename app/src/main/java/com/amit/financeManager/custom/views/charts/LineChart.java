package com.amit.financeManager.custom.views.charts;
        ...
        if(price_max > 2000 || price_min < -2000) {
            if(price_max > 4000 || price_min < -4000){
                if(price_max > 8000 || price_min < -8000){
                    ...
                    canvas.drawText("  Rs. 4000",20,middle - step_8 + 60, blackPaint);

                    canvas.drawPoint(0, middle - step_16 + 20, blackPoint);

                    canvas.drawPoint(0, middle - step_4 + 20, blackPoint);
                    canvas.drawText("  Rs. 8000",20,middle - step_4 + 60, blackPaint);

                    canvas.drawPoint(0, middle - step_4 - step_16 + 20, blackPoint);

                    canvas.drawPoint(0, middle - step_4 - step_8 + 20, blackPoint);
                    canvas.drawText("  1Rs. 2000",20,middle - step_4 - step_8 + 60, blackPaint);

                    canvas.drawPoint(0, middle - step_4 - step_8 - step_16 + 20, blackPoint);

                    canvas.drawPoint(0, middle - step_4 - step_4 + 20, blackPoint);
                    canvas.drawText("  1Rs. 6000",20,middle - step_4 - step_4 + 60, blackPaint);

                    canvas.drawPoint(0, middle + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_8 - 20, blackPoint);
                    canvas.drawText("- Rs. 4000",20, middle + step_8 - 40, blackPaint);

                    canvas.drawPoint(0, middle + step_8 + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_4 - 20, blackPoint);
                    canvas.drawText("- Rs. 8000",20, middle + step_4 - 40, blackPaint);

                    canvas.drawPoint(0, middle + step_4 + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_4 + step_8 - 20, blackPoint);
                    canvas.drawText("- 1Rs. 2000",20, middle + step_4 + step_8 - 40, blackPaint);

                    canvas.drawPoint(0, middle + step_4 + step_8 + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_4 + step_4 - 20, blackPoint);
                    canvas.drawText("- 1Rs. 6000",20, middle + step_4 + step_4 - 40, blackPaint);
                }else{
                    divider = 16;
                    ...
                    canvas.drawPoint(0, middle - step_8 - step_16+ 20, blackPoint);
                    canvas.drawPoint(0, middle - step_8 + 20, blackPoint);
                    canvas.drawText("  Rs. 2000",20,middle - step_8 + 60, blackPaint);

                    canvas.drawPoint(0, middle - step_16 + 20, blackPoint);

                    canvas.drawPoint(0, middle - step_4 + 20, blackPoint);
                    canvas.drawText("  Rs. 4000",20,middle - step_4 + 60, blackPaint);

                    canvas.drawPoint(0, middle - step_4 - step_16 + 20, blackPoint);

                    canvas.drawPoint(0, middle - step_4 - step_8 + 20, blackPoint);
                    canvas.drawText("  Rs. 6000",20,middle - step_4 - step_8 + 60, blackPaint);

                    canvas.drawPoint(0, middle - step_4 - step_8 - step_16 + 20, blackPoint);

                    canvas.drawPoint(0, middle - step_4 - step_4 + 20, blackPoint);
                    canvas.drawText("  Rs. 8000",20,middle - step_4 - step_4 + 60, blackPaint);

                    canvas.drawPoint(0, middle + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_8 - 20, blackPoint);
                    canvas.drawText("- Rs. 2000",20, middle + step_8 - 40, blackPaint);

                    canvas.drawPoint(0, middle + step_8 + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_4 - 20, blackPoint);
                    canvas.drawText("- Rs. 4000",20, middle + step_4 - 40, blackPaint);

                    canvas.drawPoint(0, middle + step_4 + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_4 + step_8 - 20, blackPoint);
                    canvas.drawText("- Rs. 6000",20, middle + step_4 + step_8 - 40, blackPaint);

                    canvas.drawPoint(0, middle + step_4 + step_8 + step_16 - 20, blackPoint);

                    canvas.drawPoint(0, middle + step_4 + step_4 - 20, blackPoint);
                    canvas.drawText("- Rs. 8000",20, middle + step_4 + step_4 - 40, blackPaint);
                }
            }else{
                divider = 8;
                ...
                canvas.drawPoint(0, middle - step_8 + 20, blackPoint);
                canvas.drawText("  Rs. 1000",20,middle - step_8 + 60, blackPaint);

                canvas.drawPoint(0, middle - step_4 + 20, blackPoint);
                canvas.drawText("  Rs. 2000",20,middle - step_4 + 60, blackPaint);

                canvas.drawPoint(0, middle - step_4 - step_8 + 20, blackPoint);
                canvas.drawText("  Rs. 3000",20,middle - step_4 - step_8 + 60, blackPaint);

                canvas.drawPoint(0, middle - step_4 - step_4 + 20, blackPoint);
                canvas.drawText("  Rs. 4000",20,middle - step_4 - step_4 + 60, blackPaint);

                canvas.drawPoint(0, middle + step_8 - 20, blackPoint);
                canvas.drawText("- Rs. 1000",20, middle + step_8 - 40, blackPaint);

                canvas.drawPoint(0, middle + step_4 - 20, blackPoint);
                canvas.drawText("- Rs. 2000",20, middle + step_4 - 40, blackPaint);

                canvas.drawPoint(0, middle + step_4 + step_8 - 20, blackPoint);
                canvas.drawText("- Rs. 3000",20, middle + step_4 + step_8 - 40, blackPaint);

                canvas.drawPoint(0, middle + step_4 + step_4 - 20, blackPoint);
                canvas.drawText("- Rs. 4000",20, middle + step_4 + step_4 - 40, blackPaint);
            }
        }else {
            divider = 4;
            canvas.drawLine(0,middle - step_4 - step_4 + 20, getMeasuredWidth(),middle - step_4 - step_4 + 20, thinPaint);
            ...
            canvas.drawPoint(0, middle - step_4 + 20, blackPoint);
            canvas.drawText("  Rs. 2000",20,middle - step_4 - step_4 + 60, blackPaint);

            canvas.drawPoint(0, middle - step_4 - step_4 + 20, blackPoint);
            canvas.drawText("  Rs. 1000",20,middle - step_4 + 60, blackPaint);

            canvas.drawPoint(0, middle + step_4 - 20, blackPoint);
            canvas.drawText("- Rs. 1000",20, middle + step_4 - 40, blackPaint);

            canvas.drawPoint(0, middle  +step_4 + step_4 - 20, blackPoint);
            canvas.drawText("- Rs. 2000",20, middle + step_4 + step_4 -40, blackPaint);
        }
